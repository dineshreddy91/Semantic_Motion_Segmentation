...
class LDataset
{
	...
	public :
		...
		const char *imageFolder,*flowFolder,*deepflow,*datasetName, *imageExtension,*flowExtension, *groundTruthFolder, *groundTruthExtension, *trainFolder, *testFolder, *dispTestFolder;
		int optimizeAverage;
		...
		const char *motionTestFolder,*motionFolder,*motionExtension;
		int motionClassNo, motionUnaryFactor;

		double cameraBaseline,cameraU,cameraV, cameraHeight, cameraFocalLength, cameraAspectRatio, cameraWidthOffset, cameraHeightOffset;
...
class LKittiDataset : public LDataset
{
	...
	public :
		...
		void DisparityRgbToLabel(unsigned char *rgb, unsigned char *label);
		void DisparityLabelToRgb(unsigned char *label, unsigned char *rgb);
		void motionRgbToLabel(unsigned char *rgb, unsigned char *label);
		void motionLabelToRgb(unsigned char *label, unsigned char *rgb);
};
